public class BricksOrderingDetailsRESTClient{
...
JSONObject json=new JSONObject();
		...
		json.put("customerName","ESHA");
		json.put("BrickCount","100");
		Client client = Client.create();	
		WebResource webResource = client .resource("{hostedURL}/business/orderBricks/);
